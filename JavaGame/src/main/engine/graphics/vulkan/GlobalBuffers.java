...
public class GlobalBuffers {
    ...
    public void loadInstanceData(Scene scene, List<VulkanModel> vulkanModels, int currentSwapChainIdx) {
        ...
        loadInstanceData(scene, vulkanModels, instanceDataBuffers[currentSwapChainIdx], excludeAnimatedGameItemsPredicate);
        Predicate<VulkanModel> excludedStaticGameItemsPredicate = v -> !v.hasAnimations();
        loadInstanceData(scene, vulkanModels, animInstanceDataBuffers[currentSwapChainIdx], excludedStaticGameItemsPredicate);
    }
