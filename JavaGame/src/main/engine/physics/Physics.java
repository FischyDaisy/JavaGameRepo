...
public class Physics {
	...
	public static GameItem createPrimitiveCollision(NewtonWorld world, Physics physics, Scene scene, List<ModelData> modelDataList, String modelId, String gameitemId, 
			CollisionPrimitive primitive, float[] params, float[] offsetMatrix, float mass, ResourceScope scope) {
		...
		return switch (primitive) {
			case BOX -> {
				...
				NewtonCollision collision = NewtonBox.create(world, params[0], params[1], params[2], 0, offsetMatrix, allocator);
				NewtonMesh mesh = NewtonMesh.createFromCollision(collision);
				NewtonBody body = NewtonDynamicBody.create(world, collision, matArr, allocator);
		    	...
		    	body.setForceAndTorqueCallback(Physics::applyGravity, scope);
		    	item.setBody(body);
			...
			case CAPSULE -> {
				GameItem item = new GameItem(gameitemId, modelId);
				NewtonCollision collision = NewtonCapsule.create(world, params[0], params[1], params[2], 0, offsetMatrix, allocator);
				NewtonMesh mesh = NewtonMesh.createFromCollision(collision);
				NewtonBody body = NewtonDynamicBody.create(world, collision, matArr, allocator);
				float[] inertiaOrigin = collision.calculateInertiaMatrix();
		    	float[] origin = new float[] {inertiaOrigin[3], inertiaOrigin[4], inertiaOrigin[5]};
			...
			case CHAMFERCYLINDER -> {
				GameItem item = new GameItem(gameitemId, modelId);
				NewtonCollision collision = NewtonChamferCylinder.create(world, params[0], params[1], 0, offsetMatrix, allocator);
				NewtonMesh mesh = NewtonMesh.createFromCollision(collision);
				NewtonBody body = NewtonDynamicBody.create(world, collision, matArr, allocator);
				float[] inertiaOrigin = collision.calculateInertiaMatrix();
		    	float[] origin = new float[] {inertiaOrigin[3], inertiaOrigin[4], inertiaOrigin[5]};
			...
			case CONE -> {
				GameItem item = new GameItem(gameitemId, modelId);
				NewtonCollision collision = NewtonCone.create(world, params[0], params[1], 0, offsetMatrix, allocator);
				NewtonMesh mesh = NewtonMesh.createFromCollision(collision);
				NewtonBody body = NewtonDynamicBody.create(world, collision, matArr, allocator);
				float[] inertiaOrigin = collision.calculateInertiaMatrix();
		    	float[] origin = new float[] {inertiaOrigin[3], inertiaOrigin[4], inertiaOrigin[5]};
			...
			case CYLINDER -> {
				GameItem item = new GameItem(gameitemId, modelId);
				NewtonCollision collision = NewtonCylinder.create(world, params[0], params[1], params[2], 0, offsetMatrix, allocator);
				NewtonMesh mesh = NewtonMesh.createFromCollision(collision);
				NewtonBody body = NewtonDynamicBody.create(world, collision, matArr, allocator);
				float[] inertiaOrigin = collision.calculateInertiaMatrix();
		    	float[] origin = new float[] {inertiaOrigin[3], inertiaOrigin[4], inertiaOrigin[5]};
			...
			case SPHERE -> {
				GameItem item = new GameItem(gameitemId, modelId);
				NewtonCollision collision = NewtonSphere.create(world, params[0], 0, offsetMatrix, allocator);
				NewtonMesh mesh = NewtonMesh.createFromCollision(collision);
				NewtonBody body = NewtonDynamicBody.create(world, collision, matArr, allocator);
				float[] inertiaOrigin = collision.calculateInertiaMatrix();
		    	float[] origin = new float[] {inertiaOrigin[3], inertiaOrigin[4], inertiaOrigin[5]};
