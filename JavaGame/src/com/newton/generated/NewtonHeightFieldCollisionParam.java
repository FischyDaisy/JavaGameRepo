...
public class NewtonHeightFieldCollisionParam {
    ...
    public static MemoryAddress m_vertialElevation$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)NewtonHeightFieldCollisionParam.m_vertialElevation$VH.get(seg);
    }
    ...
    public static MemoryAddress m_vertialElevation$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)NewtonHeightFieldCollisionParam.m_vertialElevation$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress m_atributes$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)NewtonHeightFieldCollisionParam.m_atributes$VH.get(seg);
    }
    ...
    public static MemoryAddress m_atributes$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)NewtonHeightFieldCollisionParam.m_atributes$VH.get(seg.asSlice(index*sizeof()));
    }
