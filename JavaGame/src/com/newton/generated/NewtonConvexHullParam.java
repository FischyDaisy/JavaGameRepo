...
public class NewtonConvexHullParam {
    ...
    public static MemoryAddress m_vertex$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)NewtonConvexHullParam.m_vertex$VH.get(seg);
    }
    ...
    public static MemoryAddress m_vertex$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)NewtonConvexHullParam.m_vertex$VH.get(seg.asSlice(index*sizeof()));
    }
